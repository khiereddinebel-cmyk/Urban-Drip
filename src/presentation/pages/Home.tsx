    ...
    return (
        <main className="min-h-screen bg-[var(--bg)] font-sans text-[var(--text)]">
            ...
            <section className="max-w-[1400px] mx-auto py-16 px-4 md:px-8 mt-24 lg:mt-32 text-center mb-16">
                ...
                >
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3198.71884399222!2d2.6919874!3d36.6474282!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x128f9d0062a803e3%3A0x982db2fd36775a0f!2sUrban%20drip!5e0!3m2!1sen!2s!4v1700000000000!5m2!1sen!2s"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
